...
def db_seed():
    mercury = Planet(planet_name='Mercury', planet_type='Class D', home_star='Sol', mass=3.258e23, radius=1516, distance=34.98e6)
    ...
    # add to databases as records
    db.session.add(mercury)
    db.session.add(venus)
    db.session.add(earth)

    # add test user
    test_user = User(first_name="William", last_name"Herschel", email="test@test.com", password="P@assw0rd")
